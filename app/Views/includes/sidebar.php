        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            <div class="info">
                <?php if (isset($userData)): ?>
                    <a href="#" class="d-block"><?= "{$userData['userInfo']['first_name']} {$userData['userInfo']['last_name']}" ?> :
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                ...
                <li class="nav-item">
                    ...
                    <ul class="nav nav-treeview">
                        <?php if (isset($userData['$employeeRoleId']) and in_array($userData['employeeRoleId'], session()->get('employeeRoles'))): ?>
                            <li class="nav-item">
