...
class LineManagerPermissionCheck implements FilterInterface
{
    /**
    ...
    public function before(RequestInterface $request, $arguments = null)
    {
        ...
        if (in_array($lineManagerRoleId, session()->get('employeeRoles')) or in_array($learningDevRoleId, session()->get('employeeRoles'))) {
            return null;
        }
