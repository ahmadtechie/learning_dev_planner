...
class TrainerPermissionCheck implements FilterInterface
{
    /**
    ...
    public function before(RequestInterface $request, $arguments = null)
    {
        ...
        if (in_array($trainerRoleId, session()->get('employeeRoles')) or in_array($learningDevRoleId, session()->get('employeeRoles'))) {
            return null;
        }
